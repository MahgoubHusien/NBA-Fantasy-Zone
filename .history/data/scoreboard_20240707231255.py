...
for game_date in game_dates:
    ...
    for index, line in line_score_df.iterrows():
        ...
        """, (
            ...
            line.get('PTS_OT8', 0), line.get('PTS_OT9', 0), line.get('PTS_OT10', 0), line['PTS'], line['FG_PCT'], line['FT_PCT'], line['FG3_PCT'], line['AST'], line['REB'], line['TOV']
        ))
    ...
    for index, available in available_df.iterrows():
        cursor.execute("""
            ...
            ON CONFLICT (game_id) DO NOTHING
        """, (
            available['GAME_ID'], available['PT_AVAILABLE'], available.get('PT_XYZ_AVAILABLE', 0), available.get('WH_STATUS', 0)
        ))
