    ...
    try:
        ...
        with conn.cursor() as cur:
            cur.execute(query_league_dash_stats, (
                ...
                player_stats_dict['DD2'], player_stats_dict['TD3'], player_stats_dict.get('GP_RANK', None), player_stats_dict.get('W_RANK', None), player_stats_dict.get('L_RANK', None), player_stats_dict.get('W_PCT_RANK', None), player_stats_dict.get('MIN_RANK', None), player_stats_dict.get('FGM_RANK', None), player_stats_dict.get('FGA_RANK', None), player_stats_dict.get('FG_PCT_RANK', None),
                player_stats_dict.get('FG3M_RANK', None), player_stats_dict.get('FG3A_RANK', None), player_stats_dict.get('FG3_PCT_RANK', None), player_stats_dict.get('FTM_RANK', None), player_stats_dict.get('FTA_RANK', None), player_stats_dict.get('FT_PCT_RANK', None), player_stats_dict.get('OREB_RANK', None), player_stats_dict.get('DREB_RANK', None), player_stats_dict.get('REB_RANK', None), player_stats_dict.get('AST_RANK', None),
                player_stats_dict.get('TOV_RANK', None), player_stats_dict.get('STL_RANK', None), player_stats_dict.get('BLK_RANK', None), player_stats_dict.get('BLKA_RANK', None), player_stats_dict.get('PF_RANK', None), player_stats_dict.get('PFD_RANK', None), player_stats_dict.get('PTS_RANK', None), player_stats_dict.get('PLUS_MINUS_RANK', None), player_stats_dict.get('NBA_FANTASY_PTS_RANK', None),
