...
def fetch_head_coach(team_id, season='2023-24', timeout=60):
...
def insert_head_coach(cursor, head_coach):
    # Convert is_assistant to boolean
    is_assistant = bool(head_coach['IS_ASSISTANT'])
    ...
    """, (
        head_coach['TEAM_ID'], head_coach['SEASON'], int(head_coach['COACH_ID']),
        head_coach['FIRST_NAME'], head_coach['LAST_NAME'], head_coach['COACH_TYPE'],
        head_coach['SORT_SEQUENCE'], is_assistant
    ))
