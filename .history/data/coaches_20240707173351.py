...
# Function to fetch and insert head coaches data
def fetch_and_insert_head_coaches(season='2023-24', season_type='Regular Season'):
    ...
    for team in nba_teams:
        ...
        coaches_df = team_roster.get_data_frames()[1]  # Coaches data is the second DataFrame
...
# Fetch and insert head coaches data
...
print("Head coaches data inserted into PostgreSQL database successfully.")
