        ...
        for index, line in line_score_df.iterrows():
            try:
                ...
                values = (
                    ...
                    line.get('PTS_QTR1', 0), line.get('PTS_QTR2', 0), line.get('PTS_QTR3', 0), line.get('PTS_QTR4', 0), 
                    line.get('PTS_OT1', 0), line.get('PTS_OT2', 0), line.get('PTS_OT3', 0), line.get('PTS_OT4', 0), 
                    line.get('PTS_OT5', 0), line.get('PTS_OT6', 0), line.get('PTS_OT7', 0), line.get('PTS_OT8', 0), 
                    line.get('PTS_OT9', 0), line.get('PTS_OT10', 0), line['PTS'], round(line['FG_PCT'], 2), 
                    round(line['FT_PCT'], 2), round(line['FG3_PCT'], 2), line['AST'], line['REB'], line['TOV']
                )
