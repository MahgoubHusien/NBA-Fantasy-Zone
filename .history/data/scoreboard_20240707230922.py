...
for game_date in game_dates:
    ...
    for index, line in line_score_df.iterrows():
        cursor.execute("""
            INSERT INTO line_score (game_id, team_id, team_abbreviation, team_city_name, team_name, pts_qtr1, pts_qtr2, pts_qtr3, pts_qtr4, pts_ot1, pts_ot2, pts_ot3, pts_ot4, pts_ot5, pts_ot6, pts_ot7, pts_ot8, pts_ot9, pts_ot10, pts)
