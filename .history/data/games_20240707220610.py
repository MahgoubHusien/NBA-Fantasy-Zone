...
for index, game in games_df.iterrows():
    ...
    if game_date < today:
        ...
        for _, player in player_stats.iterrows():
            cursor.execute("""
                INSERT INTO player_stats (game_id, player_id, player_name, team_id, team_abbreviation, min, pts, reb, ast, stl, blk, "to", fgm, fga, fg_pct, fg3m, fg3a, fg3_pct, ftm, fta, ft_pct)
            ...
            """, (
                ...
                player['FTM'], player['FTA'], player['FT_PCT']
            ))
    else:
