    ...
    try:
        ...
        for index, line in line_score_df.iterrows():
            try:
                ...
                values = (
                    line['GAME_DATE_EST'], line['GAME_SEQUENCE'], line['GAME_ID'], line['TEAM_ID'], line['TEAM_ABBREVIATION'],
                    line['TEAM_CITY_NAME'], line['TEAM_NAME'], line.get('PTS_QTR1', 0), line.get('PTS_QTR2', 0),
                    line.get('PTS_QTR3', 0), line.get('PTS_QTR4', 0), line.get('PTS_OT1', 0), line.get('PTS_OT2', 0),
                    line.get('PTS_OT3', 0), line.get('PTS_OT4', 0), line.get('PTS_OT5', 0), line.get('PTS_OT6', 0),
                    line.get('PTS_OT7', 0), line.get('PTS_OT8', 0), line.get('PTS_OT9', 0), line.get('PTS_OT10', 0),
                    line['PTS'], round(line['FG_PCT'], 2), round(line['FT_PCT'], 2), round(line['FG3_PCT'], 2),
                    line['AST'], line['REB'], line['TOV']
                )
                print(f"Inserting line score data: {values}")
                cursor.execute("""
                    INSERT INTO line_score (game_date_est, game_sequence, game_id, team_id, team_abbreviation, team_city_name, team_name, pts_qtr1, pts_qtr2, pts_qtr3, pts_qtr4, pts_ot1, pts_ot2, pts_ot3, pts_ot4, pts_ot5, pts_ot6, pts_ot7, pts_ot8, pts_ot9, pts_ot10, pts, fg_pct, ft_pct, fg3_pct, ast, reb, tov)
