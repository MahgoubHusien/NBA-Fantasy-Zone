...
def check_and_create_tables(conn):
    ...
    CREATE TABLE IF NOT EXISTS standings (
        ...
        seeding_game_1_id INT,
        seeding_game_2_id INT,
        seeding_game_3_id INT,
        seeding_game_4_id INT,
        seeding_game_5_id INT,
        seeding_game_6_id INT,
        seeding_game_7_id INT,
        seeding_game_8_id INT,
        seeding_game_1_opponent VARCHAR(10),
        seeding_game_2_opponent VARCHAR(10),
        seeding_game_3_opponent VARCHAR(10),
        seeding_game_4_opponent VARCHAR(10),
        seeding_game_5_opponent VARCHAR(10),
        seeding_game_6_opponent VARCHAR(10),
        seeding_game_7_opponent VARCHAR(10),
        seeding_game_8_opponent VARCHAR(10),
        seeding_game_1_label VARCHAR(50),
        seeding_game_2_label VARCHAR(50),
        seeding_game_3_label VARCHAR(50),
        seeding_game_4_label VARCHAR(50),
        seeding_game_5_label VARCHAR(50),
        seeding_game_6_label VARCHAR(50),
        seeding_game_7_label VARCHAR(50),
        seeding_game_8_label VARCHAR(50)
    );
    """
        ...
        with conn.cursor() as cur:
            for index, row in standings.iterrows():
                cur.execute(query_standings, (
                    ...
                    row['HOME'], row['ROAD'], row['L10'], row['Last10Home'], row['Last10Road'], row['OT'], 
                    row['ThreePTSOrLess'], row['TenPTSOrMore'], row['LongHomeStreak'], row['strLongHomeStreak'], 
                    row['LongRoadStreak'], row['strLongRoadStreak'], row['LongWinStreak'], row['LongLossStreak'], 
                    row['CurrentHomeStreak'], row['strCurrentHomeStreak'], row['CurrentRoadStreak'], 
                    row['strCurrentRoadStreak'], row['CurrentStreak'], row['strCurrentStreak'], 
                    row['ConferenceGamesBack'], row['DivisionGamesBack'], row['ClinchedConferenceTitle'], 
                    row['ClinchedDivisionTitle'], row['ClinchedPlayoffBirth'], row['EliminatedConference'], 
                    row['EliminatedDivision'], row['AheadAtHalf'], row['BehindAtHalf'], row['TiedAtHalf'], 
                    row['AheadAtThird'], row['BehindAtThird'], row['TiedAtThird'], row['Score100PTS'], 
                    row['OppScore100PTS'], row['OppOver500'], row['LeadInFGPCT'], row['LeadInReb'], 
                    row['FewerTurnovers'], row['PointsPG'], row['OppPointsPG'], row['DiffPointsPG'], 
                    row['vsEast'], row['vsAtlantic'], row['vsCentral'], row['vsSoutheast'], row['vsWest'], 
                    row['vsNorthwest'], row['vsPacific'], row['vsSouthwest'], row['Jan'], row['Feb'], row['Mar'], 
                    row['Apr'], row['May'], row['Jun'], row['Jul'], row['Aug'], row['Sep'], row['Oct'], row['Nov'], 
                    row['Dec'], row['ReturnToPlay_East_PI_Flag'], row['ReturnToPlay_West_PI_Flag'], 
                    row['ReturnToPlay_Already_Eliminated'], row['Seeding_Game_1_Outcome'], row['Seeding_Game_2_Outcome'], 
                    row['Seeding_Game_3_Outcome'], row['Seeding_Game_4_Outcome'], row['Seeding_Game_5_Outcome'], 
                    row['Seeding_Game_6_Outcome'], row['Seeding_Game_7_Outcome'], row['Seeding_Game_8_Outcome'], 
                    row['Seeding_Game_1_ID'], row['Seeding_Game_2_ID'], row['Seeding_Game_3_ID'], row['Seeding_Game_4_ID'], 
                    row['Seeding_Game_5_ID'], row['Seeding_Game_6_ID'], row['Seeding_Game_7_ID'], row['Seeding_Game_8_ID'], 
                    row['Seeding_Game_1_Opponent'], row['Seeding_Game_2_Opponent'], row['Seeding_Game_3_Opponent'], 
                    row['Seeding_Game_4_Opponent'], row['Seeding_Game_5_Opponent'], row['Seeding_Game_6_Opponent'], 
                    row['Seeding_Game_7_Opponent'], row['Seeding_Game_8_Opponent'], row['Seeding_Game_1_Label'], 
                    row['Seeding_Game_2_Label'], row['Seeding_Game_3_Label'], row['Seeding_Game_4_Label'], 
                    row['Seeding_Game_5_Label'], row['Seeding_Game_6_Label'], row['Seeding_Game_7_Label'], 
                    row['Seeding_Game_8_Label']
                ))
            conn.commit()
