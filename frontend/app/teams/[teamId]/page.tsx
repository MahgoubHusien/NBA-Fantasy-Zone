    ...
    <div className="container mx-auto p-4 max-w-4xl">
      <div className="bg-white p-6 rounded-lg shadow-lg mb-6 border-solid2">
        <div className="flex items-center justify-center mb-4">
          ...
          <div>
            <h1 className="text-4xl font-extrabold text-[#333333]-800 mb-2">{standing.teamCity} {standing.teamName}</h1>
      ...
      <div className="flex justify-center mb-4">
        <button
          className={`px-4 py-2 font-bold text-lg ${activeTab === 'stats' ? 'text-[#333333] border-b-4 border-[#333333]' : 'text-gray-500'}`}
          onClick={() => setActiveTab('stats')}
        >
          Stats
        </button>
        <button
          className={`ml-8 px-4 py-2 font-bold text-lg ${activeTab === 'roster' ? 'text-[#333333] border-b-4 border-[#333333]' : 'text-gray-500'}`}
              ...
              <table className="min-w-full divide-y divide-gray-200" style={{ minWidth: '900px' }}>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  <tr>
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.fieldGoalsMade}</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Field Goals Attempted</td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.fieldGoalsAttempted}</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Field Goal Percentage</td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.fieldGoalPct}</td>
                  </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Three Pointers Made</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.threePointersMade}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Three Pointers Attempted</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.threePointersAttempted}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Three Point Percentage</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.threePointPct}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Free Throws Made</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.freeThrowsMade}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Free Throws Attempted</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.freeThrowsAttempted}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Free Throw Percentage</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.freeThrowPct}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Offensive Rebounds</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.offensiveRebounds}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Defensive Rebounds</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.defensiveRebounds}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Total Rebounds</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.totalRebounds}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Assists</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.assists}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Turnovers</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.turnovers}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Steals</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.steals}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Blocks</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.blocks}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Personal Fouls</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.personalFouls}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Personal Fouls Drawn</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.personalFoulsDrawn}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Points</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.points}</td>
                </tr>
                <tr>
              ...
              <table className="min-w-full divide-y divide-gray-200" style={{ minWidth: '900px' }}>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.winRank}</td>
                  </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Losses Rank</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.lossRank}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.fieldGoalsMadeRank}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Field Goals Attempted Rank</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.fieldGoalsAttemptedRank}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Field Goal Percentage Rank</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.fieldGoalPctRank}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Three Pointers Made Rank</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.threePointersMadeRank}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Three Pointers Attempted Rank</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.threePointersAttemptedRank}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Three Point Percentage Rank</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.threePointPctRank}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Free Throws Made Rank</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.freeThrowsMadeRank}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.freeThrowPctRank}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Offensive Rebounds Rank</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.offensiveReboundsRank}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Defensive Rebounds Rank</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.defensiveReboundsRank}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Total Rebounds Rank</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.totalReboundsRank}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Assists Rank</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.assistsRank}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Turnovers Rank</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.turnoversRank}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Steals Rank</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.stealsRank}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Blocks Rank</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.blocksRank}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Blocks Against Rank</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.blocksAgainstRank}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Personal Fouls Rank</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.personalFoulsRank}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Personal Fouls Drawn Rank</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.personalFoulsDrawnRank}</td>
                </tr>
                <tr>
                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Points Rank</td>
                  <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{teamStats.pointsRank}</td>
                </tr>
                <tr>
              ...
              <table className="min-w-full divide-y divide-gray-200" style={{ minWidth: '900px' }}>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{standing.clinchedConferenceTitle ? 'True' : 'False'}</td>
                  </tr>
                  <tr>
                    <td className="py-2 px-4 whitespace-nowrap text-sm font-medium text-gray-900">Clinched Playoff Birth</td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{standing.clinchedPlayoffBirth ? 'True' : 'False'}</td>
                  </tr>
                  <tr>
                    <td className="py-2 px-4 whitespace-nowrap text-sm font-medium text-gray-900">Clinched Play-In</td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{standing.clinchedPlayin ? 'True' : 'False'}</td>
                  </tr>
                  <tr>
                    <td className="py-2 px-4 whitespace-nowrap text-sm font-medium text-gray-900">Eliminated from Conference</td>
                    <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500 text-right">{standing.eliminatedConference ? 'True' : 'False'}</td>
                  </tr>
                  <tr>
                ...
                <table className="min-w-full divide-y divide-gray-200" style={{ minWidth: '900px' }}>
                  <thead>
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">TOPG</th>
                      <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">PFPG</th>
                    </tr>
                  </thead>
                  <tbody className="bg-white divide-y divide-gray-200">
                    {players.map((player) => (
                      <tr key={player.playerId}>
                        ...
                        <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">{player.height}</td>
                        <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">{player.weight}</td>
                        <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">{player.jersey}</td>
                        <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">{player.ppg}</td>
                        <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">{player.apg}</td>
                        <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">{player.rpg}</td>
                        <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">{player.spg}</td>
                        <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">{player.bpg}</td>
                        <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">{player.topg}</td>
                        <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-500">{player.pfpg}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
